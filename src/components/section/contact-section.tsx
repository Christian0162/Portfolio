...
export default function ContactSection() {
  return (
    <div className="md:mt-6 mt-0 border border-border/50 bg-card/30 backdrop-blur-md p-10 sm:p-14 rounded-3xl relative overflow-hidden shadow-2xl w-full max-w-xl mx-auto flex flex-col items-center gap-6 text-center">
